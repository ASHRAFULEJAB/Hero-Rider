                ...
                <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                  <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight
                   text-white sm:text-4xl sm:leading-none">
                    Places To Study <br className="hidden md:block" />
                    For a {" "}
                    <span className="text-teal-400">Group Study</span>
                  </h2>
                  ...
                  <a
                    ...
                    font-semibold tracking-wider transition-colors duration-200 text-teal-400 hover:text-teal-700"
                  >
                    Learn more
                    <svg
                      ...
                      <div className="mt-4 mb-2 sm:mb-4">
                        <button
                          ...
                          w-full h-12 px-6 font-medium tracking-wide text-white
                           transition duration-200 rounded shadow-md bg-gray-900 
